...
## [ ] 1. Establish the acceptance harness

- [ ] 1.1 Record exact app, engine, fixture, schema, and clean-state identifiers. (refs Req 7.1, Req 7.4)
- [ ] 1.2 Make Acceptances A–G repeatable with isolated app data and disposable clones. (refs Req 7.1)
- [ ] 1.3 Prove the original fixture and real application data remain unchanged. (refs Req 7.1)
